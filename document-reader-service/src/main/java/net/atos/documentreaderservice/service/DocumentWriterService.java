...
public class DocumentWriterService {
    ...
    public Document uploadDocument(UUID parentId, MultipartFile file) throws IOException {
        String path="";
        ...
        System.out.println("parentDirectory's parentID: "+parentDirectory.getId());
        System.out.println("parentDirectory's workspace: "+parentDirectory.getWorkspaceId());
    ...
    public Document updateDocument(DocumentDto document, UUID id){
